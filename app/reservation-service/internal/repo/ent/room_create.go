...
func (rc *RoomCreate) SetIsAvailable(b bool) *RoomCreate {
	rc.mutation.SetIsAvailable(b)
	return rc
}

// SetNillableIsAvailable sets the "is_available" field if the given value is not nil.
func (rc *RoomCreate) SetNillableIsAvailable(b *bool) *RoomCreate {
	if b != nil {
		rc.SetIsAvailable(*b)
	}
	return rc
...
func (rc *RoomCreate) AddReservationIDs(ids ...uuid.UUID) *RoomCreate {
...
func (rc *RoomCreate) defaults() {
	if _, ok := rc.mutation.IsAvailable(); !ok {
		v := room.DefaultIsAvailable
		rc.mutation.SetIsAvailable(v)
	}
...
func (rc *RoomCreate) check() error {
	...
	if _, ok := rc.mutation.IsAvailable(); !ok {
		return &ValidationError{Name: "is_available", err: errors.New(`ent: missing required field "Room.is_available"`)}
	}
	if _, ok := rc.mutation.CreatedAt(); !ok {
...
func (rc *RoomCreate) createSpec() (*Room, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.IsAvailable(); ok {
